...
namespace LeaveManagementWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        //OnGetAsync and OnPostAsync are the handlers
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();//This createuser() will create an object of employee and then store it into the user

                await _userStore.SetUserNameAsync(user, Input.Email, CancellationToken.None);
                await _emailStore.SetEmailAsync(user, Input.Email, CancellationToken.None);
                var result = await _userManager.CreateAsync(user, Input.Password);//Here we are calling the userManager to create the password with this user object
